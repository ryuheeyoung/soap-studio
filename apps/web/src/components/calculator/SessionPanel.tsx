          ...
          return (
            <li key={item.recipeId}>
              ...
              <div className="flex items-center gap-3 p-3">
                ...
                <Stepper
                  value={item.scale}
                  onChange={(v) => setScale(item.recipeId, v)}
                  min={0.5}
                  step={0.5}
                  format={(v) => `×${v}`}
                />
