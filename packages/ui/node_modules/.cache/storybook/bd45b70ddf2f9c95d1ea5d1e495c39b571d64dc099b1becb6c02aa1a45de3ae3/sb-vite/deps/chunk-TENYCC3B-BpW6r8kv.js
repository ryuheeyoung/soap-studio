...
import { t as require_global } from "./global-8I3nb3G1.js";
import { t as require_react } from "./react.js";
import { a as __toESM$1, r as __export, t as __commonJS } from "./chunk-XP5HYGXS-BLogQhZX.js";
...
var getAct = async () => {
	...
	if (typeof clonedReact.act == "function") reactAct = clonedReact.act;
		...
		let deprecatedTestUtils = await import("./test-utils-l0TS_qeG.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1));
...
async function renderToCanvas({ storyContext, unboundStoryFn, showMain, showException, forceRemount }, canvasElement) {
	let { renderElement, unmountElement } = await import("./react-18-Df0vOCJ2.js"), Story = unboundStoryFn, content = storyContext.parameters.__isPortableStory ? import_react.createElement(Story, { ...storyContext }) : import_react.createElement(ErrorBoundary, {
		showMain,
		showException
...
var parameters = { renderer: "react" }, decorators = [(story, context) => {
	...
	let major = import_semver.default.major("19.2.4"), minor = import_semver.default.minor("19.2.4");
	...
	try {
		let { configure } = await import("./dist-BJNmE7bv.js").then((n) => n.t), act = await getAct();
		configure({
...
//# sourceMappingURL=chunk-TENYCC3B-BpW6r8kv.js.map